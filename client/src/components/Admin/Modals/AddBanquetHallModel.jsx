...
const AddBanquetHallModel = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("miniBookingAmount", banquetHallData.minBookingAmount);
    formData.append("featureDescription", banquetHallData.featureDesscription);

    if (photos && photos.length > 0) {
      Array.from(photos).forEach((photos) => {
...
export default AddBanquetHallModel;
